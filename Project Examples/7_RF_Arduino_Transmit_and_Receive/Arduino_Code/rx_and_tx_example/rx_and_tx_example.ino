...
uint8_t endereco_nrf24le1[5] = {0x42, 0x42, 0x42, 0x42, 0x42};
...
uint8_t endereco_arduino[5] = {0x2A, 0x2A, 0x2A, 0x2A, 0x2A};
...
void setup() {
  ...
  //host_nrf.rf_init(endereco_nrf24le1, endereco_arduino, 92, RF_DATA_RATE_2Mbps, RF_TX_POWER_0dBm); //RF Communication
  host_nrf.rf_init(endereco_arduino, endereco_nrf24le1, 92, RF_DATA_RATE_2Mbps, RF_TX_POWER_0dBm); //RF Communication
